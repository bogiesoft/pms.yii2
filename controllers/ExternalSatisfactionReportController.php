...
class ExternalSatisfactionReportController extends \yii\web\Controller
{
    public function actionIndex()
    {
    	...
    	if ($date != null){
			...
			$model = $connection->createCommand("
				select distinct a.projectid, b.signdate, d.company, a.name as project, e.pic, f.customerpic,
					f.extsurveyscore,
					case when date_format(b.signdate, '%m') = '01' then f.extsurveyscore end as jan,
					case when date_format(b.signdate, '%m') = '02' then f.extsurveyscore end as feb,
					case when date_format(b.signdate, '%m') = '03' then f.extsurveyscore end as mar,
					case when date_format(b.signdate, '%m') = '04' then f.extsurveyscore end as apr,
					case when date_format(b.signdate, '%m') = '05' then f.extsurveyscore end as may,
					case when date_format(b.signdate, '%m') = '06' then f.extsurveyscore end as jun,
					case when date_format(b.signdate, '%m') = '07' then f.extsurveyscore end as jul,
					case when date_format(b.signdate, '%m') = '08' then f.extsurveyscore end as aug,
					case when date_format(b.signdate, '%m') = '09' then f.extsurveyscore end as sep,
					case when date_format(b.signdate, '%m') = '10' then f.extsurveyscore end as oct,
					case when date_format(b.signdate, '%m') = '11' then f.extsurveyscore end as nov,
					case when date_format(b.signdate, '%m') = '12' then f.extsurveyscore end as decm
				from ps_project a
				...
				left join ps_finalizationproject f on a.projectid = f.projectid
				where date_format(b.signdate, '%Y') = :1
				order by b.signdate, d.company, a.name
			");
    ...
    public function actionExportExcel($date)
    {
    	...
    	if ($date != null){
			...
			$content = $content . '<tr><th rowspan="3" style="text-align:center; vertical-align:middle">No</th><th rowspan="3" style="text-align:center; vertical-align:middle">Agreement Date</th><th rowspan="3" style="text-align:center; vertical-align:middle">Client</th><th rowspan="3" style="text-align:center; vertical-align:middle">Project</th><th rowspan="3" style="text-align:center; vertical-align:middle">Customer PIC</th><th rowspan="3" style="text-align:center; vertical-align:middle">Business Development PIC</th><th rowspan="3" style="text-align:center; vertical-align:middle">Satisfaction Index Cummulative</th><th colspan="12" style="text-align:center; vertical-align:middle">Satisfication Index by Month (cummulative)</th></tr>';
			...
			$filename ="External_Satisfaction.xls";
