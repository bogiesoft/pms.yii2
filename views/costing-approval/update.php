...
$this->params['breadcrumbs'][] = ['label' => 'Costing Approval@'.date('d.M.Y H:i:s', strtotime($model->date)), 'url' => ['view', 'id' => $model->costingapprovalid, 'projectid'=>Yii::$app->request->get('projectid')]];
