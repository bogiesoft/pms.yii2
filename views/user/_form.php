...
////////////////////////////Setting Menu Form////////////////////////////////////////////////////////////////////
    ...
    foreach($menu as $data){
        ...
        $strTree = $strTree.'<li><div class="checkbox"><input type="checkbox" '.$attr.' id="UserAccess-'.$data->menuid.'" name="User[UserAccess]['.$data->menuid.']"><label class="noselect" for="UserAccess-'.$data->menuid.'">'.$data->caption.'</label></div>';
        $index = $data->level;
    }
    $strTree = $strTree . '</div>';
